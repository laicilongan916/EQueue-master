...
import static my.edu.tarc.e_queue.Home.businessViewCount;
...
public class OrganizationActivity extends AppCompatActivity {
    ...
    private String GET_URL3 = "https://bait2073equeue.000webhostapp.com/update_View.php";
                    ...
                    public void onResponse(JSONArray response) {
                        try {
                            for (int i = 0; i < response.length(); i++) {
                                ...
                                Organization serverData = new Organization
                                        (OrganizationDetail.getInt("Id"),
    ...
    /*public void updateViewCount(int position)
    {
        JsonArrayRequest jsonObjectRequest;
        jsonObjectRequest = new JsonArrayRequest(GET_URL2+"?totalView="+businessViewCount.elementAt(position).totalView+"&businessID="+position,
                new Response.Listener<JSONArray>() {
                    @Override
                    public void onResponse(JSONArray response) {
                        try {
                            ...
                            builder.setTitle("View Count Update Successful!");
                            builder.setMessage(" ");
    ...
    {
        JsonArrayRequest jsonObjectRequest = new JsonArrayRequest(GET_URL3 + "?ID=" + position,
                new Response.Listener<JSONArray>() {
                    @Override
                    public void onResponse(JSONArray response) {
                        try {
